 ...
 * integration and schedules token removal — it does not touch leads, messages,
...
export async function POST(req: NextRequest) {
  ...
  console.log(`[meta-deauthorize] meta_user_id=${metaUserId} integrations_disconnected=${disconnected}`);
