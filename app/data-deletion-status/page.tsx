 ...
 *
 * The URL returned by the Meta User Data Deletion Callback. Meta follows it to
 * confirm the request is real, so it must resolve for any code we issued.
 *
 * It reveals only the status and request date for a code the caller already
 * holds — no lead, message, org or Meta user identifier is exposed, and an
 * unknown code simply reports "not found" rather than confirming or denying
 * anything about it.
 */
