...
/**
 * Error boundary for the org workspace.
 * Catches unhandled errors in any page rendered under /org/[slug]
 * and shows a recoverable error state rather than a blank screen.
 */
    ...
    <div className="flex flex-1 flex-col items-center justify-center gap-5 px-6 py-16 text-center">
      ...
      <div className="space-y-1.5 max-w-sm">
        ...
        <p className="text-sm text-[var(--text-3)] leading-relaxed">
          An unexpected error occurred in this view. Your data is safe — refreshing will restore the page.
        </p>
        {error.digest && (
          <p className="font-mono text-[10px] text-[var(--text-3)] opacity-50">
            ref: {error.digest}
          </p>
        )}
      </div>
