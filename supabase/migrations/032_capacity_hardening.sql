...
--   - CREATE INDEX CONCURRENTLY ... IF NOT EXISTS (non-blocking)
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_scheduled_messages_due
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_job_runs_failed_recent
